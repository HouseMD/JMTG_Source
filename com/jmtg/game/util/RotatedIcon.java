...
public class RotatedIcon implements Icon {
	 ...
	 * constructor will automatically set the Rotate enum to ABOUT_CENTER. For
	 * rectangular icons the icon will be clipped before the rotation to make
	 * sure it doesn't paint over the rest of the component.
	 * 
	 * @param icon
	 *            the Icon to rotate
	 * @param angle
